...
async def token_handler(client, message):
    ...
    if len(message.command) <= 1:
        image_url = "https://i.postimg.cc/tJP1p9bP/Start.png"
        join_button = InlineKeyboardButton("Join Channel", url="https://t.me/savedrestrict")
        premium = InlineKeyboardButton("Get Premium", url="https://t.me/LPRPDVofficial")   
